...
public class Edgeversion {
    ...
    public void execute() {
    	...
    	String ver="";
    	 String line="";
    	   ...
    	   try {
               ...
               ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "wmic datafile where name=\"C:\\\\Program Files (x86)\\\\Google\\\\Chrome\\\\Application\\\\chrome.exe\" get Version /value");
               ...
               while ((line = reader.readLine()) != null) {
                   if (line.startsWith("Version=")) {
                       System.out.println("Chrome browser version: " + line.substring(8));
                      // ver =""+line.substring(8);
                   }
               }
        ...
        testExecutionContext.setValue(resultName, ver, resultScope);
